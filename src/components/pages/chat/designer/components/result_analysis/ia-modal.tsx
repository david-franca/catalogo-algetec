...
import { useReviewQuestions } from "@/services/designer.service";
...
export default function DesignerResultAnalysisIaModal({
  isOpen,
  onClose,
}: Props) {
  const [form] = Form.useForm<FormValues>();

  const { mutateAsync, isPending } = useReviewQuestions();
