...
import { useKnowledgeObjects } from "@/services/designer.service";
...
export default function DesignerKnowledgeObjectsIaModal({
  isOpen,
  onClose,
}: Props) {
  const [form] = Form.useForm<FormValues>();
  const { mutateAsync, isPending } = useKnowledgeObjects();
