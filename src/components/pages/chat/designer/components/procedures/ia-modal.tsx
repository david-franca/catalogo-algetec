...
import { useReviewScripts } from "@/services/designer.service";
...
export default function DesignerProceduresIaModal({ isOpen, onClose }: Props) {
  const [form] = Form.useForm<FormValues>();

  const { mutateAsync, isPending } = useReviewScripts();
  ...
  const dataSource = useMemo(
    () => [
      ...
      },
      {
        ...
        value: isKnowledgeObjects(),
      },
      {
        title: "Habilidades e Competências",
        value: isCorrelatedCompetences(),
      },
    ],
    [
      area_of_knowledge,
